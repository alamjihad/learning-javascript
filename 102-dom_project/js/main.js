...
function loadMilestones(){
    ...
    milestones.innerHTML = `${milestonesData.map(function(milestone){
        return `<div class="milestone border-b" id="${milestone_id}">
                <div class="flex">
                ...
                <div class="hidden_panel">
                    ${milestone.modules
                        .map(function(module){
                        return `<div class="module broder-b">
                        <p>${module.name}</p>
                        </div>`;
                    }).join("")}
                </div>
...
function openMilestone(milestoneElement, id){
    ...
    contshownPanel = document.querySelector(".shown");
    const active = document.querySelector(".active");
    // removed previous active class if any [other than the clicked one]
...
milestoneImage.onload = function(){
    this.computedStyleMap.opacity ="1";
}
